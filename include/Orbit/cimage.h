...
public:
	...
	void fill(Color);
	Image trim() const;
	Image crop(const Rect &) const;

	void copy_to(Image &, const Rect &, const Rect &, const ImageCopyParams &);
	void copy_to(Image &, const Rect &, const Quad &, const ImageCopyParams &);
